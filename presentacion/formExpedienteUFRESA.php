        ...
        <div class="card card-modern mb-4">
            <div class="card-body">
                <h5 class="card-title fw-bold mb-3" style="color: #0b2a4a;">
                    <i class="fas fa-pen-alt me-2"></i><?php echo $esEdicion ? 'Editar Expediente UFRESA' : 'Nuevo Expediente UFRESA' ?>
                </h5>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="formExpedienteFI.php?idExpediente=<?php echo $exp['idExpediente'] ?>&area=UFRESA"><i class="fas fa-gavel me-2"></i>Fase Instructora (FI)</a></li>
                                            <li><hr class="dropdown-divider"></li>
                                            <li><a class="dropdown-item" href="?editar=<?php echo $exp['idExpediente'] ?>"><i class="fas fa-edit me-2"></i>Editar Expediente</a></li>
                                            <li><a class="dropdown-item text-danger" href="eliminarExpediente.php?id=<?php echo $exp['idExpediente'] ?>&area=UFRESA" onclick="return confirm('¿Está seguro de eliminar este expediente?')"><i class="fas fa-trash-alt me-2"></i>Eliminar</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
